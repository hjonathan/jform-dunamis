/***********************************************************************************************************************************
 * COMPOSITION EXTENSION FOR DATATABLE DROPDOWN CONTROL
 * @param props
 * @returns
 ***********************************************************************************************************************************/
...
export const useDtDropdownControlComposition = (props: any) => {
  ...
  const setPropsDtDropdownControl = (control: any) => {
    return {
      id: control.id,
  ...
  const control: any = ref(setPropsDtDropdownControl(column));
  ...
  const deactivateAlpha = alphaTeoremDt({
    ...
    column: column,
    updater: (ctrl: any) => {
      control.value = setPropsDtDropdownControl(ctrl);
    },
  });
