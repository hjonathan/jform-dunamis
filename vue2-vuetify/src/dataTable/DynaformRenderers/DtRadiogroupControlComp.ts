/***********************************************************************************************************************************
 * COMPOSITION EXTENSION FOR DATATABLE RADIOGROUP CONTROL
 * @param props
 * @returns
 ***********************************************************************************************************************************/
...
export const useDtRadiogroupControlComposition = (props: any) => {
  ...
  const setPropsDtRadiogroupControl = (control: any) => {
    return {
      id: control.id,
  ...
  const control: any = ref(setPropsDtRadiogroupControl(column));
  ...
  const deactivateAlpha = alphaTeoremDt({
    ...
    column: column,
    updater: (ctrl: any) => {
      control.value = setPropsDtRadiogroupControl(ctrl);
    },
  });
