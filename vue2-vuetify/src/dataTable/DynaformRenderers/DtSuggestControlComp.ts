/***********************************************************************************************************************************
 * COMPOSITION EXTENSION FOR DATATABLE SUGGEST CONTROL
 * @param props
 * @returns
 ***********************************************************************************************************************************/
...
export const useDtSuggestControlComposition = (props: any) => {
  ...
  const setPropsDtSuggestControl = (control: any) => {
    return {
      id: control.id,
  ...
  const control: any = ref(setPropsDtSuggestControl(column));
  ...
  const deactivateAlpha = alphaTeoremDt({
    ...
    column: column,
    updater: (ctrl: any) => {
      control.value = setPropsDtSuggestControl(ctrl);
    },
  });
